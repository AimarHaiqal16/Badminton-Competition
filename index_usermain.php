...
<head>
  ...
  <title>Index - Skibidi Badminton Competition Bootstrap Template</title>
    ...
    <section id="hero" class="hero section">
      ...
      <div id="section-fqREP4OWmC-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item">
          <img src="assets\img\WIN_20220903_21_30_26_Pro.jpg" alt="">
        </div>

        <div class="carousel-item active">
          <img src="assets\img\goofy.jpeg" alt="">
        </div>

        <div class="carousel-item">
          <img src="assets\img\hero-carousel\310721mena_1627736445.jpg" alt="">
        </div>

        <div class="carousel-item">
          <img src="assets\img\hero-carousel\bG9jYWw6Ly8vcHVibGlzaGVycy8yODU0.jpg" alt="">
        </div>

        <div class="carousel-item">
          <img src="assets\img\hero-carousel\28campsi.transformed.jpg" alt="">
        </div>
    ...
    <div class="container footer-top">
      <div class="row gy-4">
        ...
        <div class="col-lg-2 col-md-3 footer-links">
          <h4> <br><br>  </h4>
          <ul>
            <p><a href="Admin 224\login.php">Admin</a></p>
          </ul>
        </div>
